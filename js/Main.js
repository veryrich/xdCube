...
function main () {
	...
	LLoadManage.load(
		...
		function (result) {
			...
			imgLogo = new LBitmapData(result["logo"]);
...
function addBeginningUI () {
	...
	// var position = new LRectangle(-50,-50,120,30);
	var bm = new LBitmap(imgLogo)
	bm.x = 140
	bm.y = 60
	beginningLayer.addChild(bm);
